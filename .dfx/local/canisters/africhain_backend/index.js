...
import { idlFactory } from './africhain_backend.did.js';
export { idlFactory } from './africhain_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AFRICHAIN_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./africhain_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the africhain_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./africhain_backend.did.js")._SERVICE>}
 */
export const africhain_backend = createActor(canisterId);
