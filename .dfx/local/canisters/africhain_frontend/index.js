...
import { idlFactory } from './africhain_frontend.did.js';
export { idlFactory } from './africhain_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AFRICHAIN_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./africhain_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the africhain_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./africhain_frontend.did.js")._SERVICE>}
 */
export const africhain_frontend = createActor(canisterId);
